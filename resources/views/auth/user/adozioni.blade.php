      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <header class="masthead" style="background-image: url('/img/b.jpg'); padding-top: 4rem; padding-bottom: 4rem;">
            ...
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item active"> <a href="{{ route('user.adozioni') }}"> Adozioni</a></li>
              </ol>
              <div class="banner-text text-center">
              ...
              <ul id="myUL" class="cards">
                ...
                <li class="cards_item">
                  <div class="card">
                    ...
                    <div class="banner-text text-center"> 
                     <button class="btn" style="background-color: #2b4c9a; color: white;" onclick="return alert('Richiesta di adozione inviata con successo.')"><i class="fas fa-share"></i> Invia richiesta di adozione</button>
                    </div>
                    </div>
                  </div>
                </li>
