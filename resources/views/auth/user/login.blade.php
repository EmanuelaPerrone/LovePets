...
@section('title', 'LovePets | Login Utente')
...
<div class="container" style="padding-top: 20px;">
    ...
    <li class="breadcrumb-item active"> <a href="{{ route('user.login') }}"> Utente</a></li>
  </ol>
            <div class="card" style="border-color: #223C7B;">
                <div class="card-header text-white" style="background-color: #26448A; font-size: 18px;"><i class="fas fa-user"></i> {{ __('Login Utente') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" placeholder="es. mariorossi@gmail.com" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                            <a  href="{{ route('user.register') }}" style="padding-left: 10px;"><u>Non hai un account? {{ __('Registrati') }}</u></a>            
                            </div></div>
                        </div>
                        <div class="seperator"><b>oppure</b></div>
                        <div class="social-icon" style="padding-top: 0px;">
        <a type="button" id="social" class="btn btn-danger" href="{{ route('login.google') }}"><i class="fa fa-google-plus-g"></i> Login con Google</a>
      </div>
                    </form>
                </div>
            </div>
