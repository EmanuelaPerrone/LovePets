    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-md-10 col-lg-8 col-xl-7">
            ...
            <div class="banner-text text-center">
                ...
                @guest
                <h2>Accedi per effettuare una segnalazione</h2>
                @endguest
                
                @if(Auth::user() && (Auth::user()->hasRole('user')))
                <a class="btn btn-lg" style="background-color: #2b4c9a; color: white; justify-content: center;" href="{{ route('user.segnalazione') }}">Effettua una segnalazione</a>
                @endif
              </div>
            </div>
        </div>
...
<div class="main">
            <ol class="breadcrumb justify-content-center">
              <li class="breadcrumb-item">Sei qui:  <a href="{{ route('user.home') }}">Home</a></li>
              <li class="breadcrumb-item active"> <a href="{{ route('user.appelli') }}"> Segnalazioni</a></li>
              </ol>
              <div class="banner-text text-center">
