                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="banner-text text-center">
                            <h1>AIUTI E FAQ</h1>
                            <h2 class="subheading">Una guida completa sull'utilizzo di Love Pets. Qui puoi trovare le risposte alle domande più frequenti</h2>
</div>
                        </div>
                    </div>
                </div>
...
<ol class="breadcrumb justify-content-center">
    ...
    <li class="breadcrumb-item active"> <a href="{{ route('user.faq') }}"> Aiuti e FAQ</a></li>
  </ol>
  <article class="mb-4">
