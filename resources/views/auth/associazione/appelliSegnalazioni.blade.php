...
.material-icons {
    ...
    <title>LovePets | Appelli segnalazioni</title>
    <link rel="stylesheet" 
          href=
          ...
          <div class="container position-relative px-4 px-lg-5">
              <div class="row gx-4 gx-lg-5 justify-content-center">
                   <div class="col-md-10 col-lg-8 col-xl-7">
                      ...
                      <h1>Segnalazioni</h1>
                          <h2 class="subheading">Di seguito puoi trovare tutte le segnalazioni che sono state effettuate filtrate per gli animali a cui ti rivolgi</h2>
                      </div>
                       </div>
                  </div>
              </div>
...
<div class="main">
  <ol class="breadcrumb justify-content-center">
    ...
    <li class="breadcrumb-item active"> <a href="{{ route('associazione.appelli') }}"> Segnalazioni</a></li>
  </ol>
  ...
  @foreach($segnalazione as $segnalazioni)
   <li class="cards_item">
    ...
    <div class="form-group" style="border-color: grey; padding-left: 20px; padding-right: 20px;">
        ...
        <strong>Segnalazione effettuata da:</strong> {{ $segnalazioni->nome }} {{ $segnalazioni->cognome }}
        @endif      
        ...
        <input type="hidden" value="{{ $segnalazioni->anonimo }}" name="anonimo"> 
        <input type="hidden" value="{{ date('d-m-Y, H:i', strtotime($segnalazioni->created_at)) }}" name="data_segnalazione">
        <select class="form-select" id="stato" name="stato" value="aperta" >
          <option selected disabled value="aperta" >Modifica stato segnalazione</option>  

          @if( $segnalazioni->contatto == 'Per Telefono')
          <option value="presa in carico">Prendi in carico</option>     
          ...
          @elseif( $segnalazioni->contatto == 'Non vuole essere aggiornato' || (is_null($segnalazioni->contatto)))
          <option value="presa in carico">Prendi in carico</option>     
          @endif
        </select>
