...
<head>
  ...
  <!-- CSRF Token -->
    ...
    <script>
      ...
      "info":           "Visualizzati _START_ di _END_ su _TOTAL_ voci",
      "infoEmpty":      "Visualizzati 0 di 0 di 0 voci",
      "infoFiltered":   "(filtrati su _MAX_ voci totali)",
      "infoPostFix":    "",
      "thousands":      ",",
...
.material-icons {
    ...
    <title>LovePets | Contatti utili</title>
    <link rel="stylesheet" 
          href=
...
<ol class="breadcrumb justify-content-center" style="margin-right: 10px; margin-left: 10px;">
    ...
    <li class="breadcrumb-item active"> <a href="{{ route('associazione.contatti') }}"> Contatti utili</a></li>
  </ol></div>
<div class="main">
