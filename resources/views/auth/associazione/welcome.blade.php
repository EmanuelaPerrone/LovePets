      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		...
		<header class="masthead" style="background-image: url('/img/banner.jpg')">
            ...
            <div class="banner-text text-center">
              <h1 class="white">Bentornata {{ Auth::user()->nome }}!</h1>
  ...
  <div class="container">
	<div class="row vh-60" style="margin-bottom: 40px;">
	  <div class="site-heading text-center">
		...
		<div onclick = "window.location = '{{ route('associazione.cosaFare') }}'" style = "cursor: pointer" class="col-sm-6 col-lg-3 my-auto">
		...
		<div onclick = "window.location = '{{ route('associazione.contatti') }}'" style = "cursor: pointer" class="col-sm-6 col-lg-3 my-auto">
			<div class="box shadow-sm p-4" style="margin-top: 10px; margin-bottom: 10px;">
				<div class="image-wrapper mb-3">
		...
		<div onclick = "window.location = '{{ route('associazione.adozioni') }}'" style = "cursor: pointer" class="col-sm-6 col-lg-3 my-auto">
			<div class="box shadow-sm p-4" style="margin-top: 10px; margin-bottom: 10px;">
				<div class="image-wrapper mb-3">
		...
		<div onclick = "window.location = '{{ route('associazione.appelli') }}'" style = "cursor: pointer" class="col-sm-6 col-lg-3 my-auto">
			<div class="box shadow-sm p-4" style="margin-top: 10px; margin-bottom: 10px;">
				<div class="image-wrapper mb-3">
