        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('appelli') }}" class="btn" style="background-color: #2b4c9a; color: white;margin-bottom: 5px;"><i class="fas fa-bullhorn"></i> Visualizza segnalazioni</a>
                    <a href="{{ route('adozioni') }}" class="btn" style="background-color: #2b4c9a; color: white;margin-bottom: 5px;"><i class="fas fa-heart"></i> Visualizza adozioni</a>
                    <a href="{{ url('/') }}" class="btn" style="background-color: #2b4c9a; color: white;margin-bottom: 5px;"><i class="fas fa-home"></i> Torna alla home</a>
